...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SectionNode.article'
        db.add_column(u'wiki_sectionnode', 'article',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='root_node', unique=True, null=True, to=orm['wiki.Article']),
                      keep_default=False)

        # Deleting field 'Section.article'
        db.delete_column(u'wiki_section', 'article_id')


    def backwards(self, orm):
        # Deleting field 'SectionNode.article'
        db.delete_column(u'wiki_sectionnode', 'article_id')

        # Adding field 'Section.article'
        db.add_column(u'wiki_section', 'article',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='section', unique=True, null=True, to=orm['wiki.Article']),
                      keep_default=False)
