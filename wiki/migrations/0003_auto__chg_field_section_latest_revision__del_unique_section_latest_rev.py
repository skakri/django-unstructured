...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Section', fields ['latest_revision']
        db.delete_unique(u'wiki_section', ['latest_revision_id'])


        # Changing field 'Section.latest_revision'
        db.alter_column(u'wiki_section', 'latest_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wiki.SectionRevision']))

    def backwards(self, orm):

        # Changing field 'Section.latest_revision'
        db.alter_column(u'wiki_section', 'latest_revision_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['wiki.SectionRevision']))
        # Adding unique constraint on 'Section', fields ['latest_revision']
        db.create_unique(u'wiki_section', ['latest_revision_id'])
    ...
    models = {
        ...
        'wiki.section': {
            ...
            'group_write': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_revision': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'latest_revision'", 'null': 'True', 'to': "orm['wiki.SectionRevision']"}),
